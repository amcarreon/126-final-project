            ...
            <form class="shopProfileForm" id="shopProfileFormID" action="../../includes/update_shop_info.php" method="post" enctype="multipart/form-data">
                ...
                <div class="socialMediaDiv">
                    <div class="socialMediaIcons">
                        ...
                        <input type="text" name="socialMediaPlatform[]" value="facebook" hidden>
                        <input type="text" name="socialMediaLink[]" class="inputFB" placeholder="Facebook Profile Link">
                    </div>
                    <br><br>
                    <div class="socialMediaIcons">
                        <i class="fa fa-instagram icon"></i>
                        <input type="text" name="socialMediaPlatform[]" value="instagram" hidden>
                        <input type="text" name="socialMediaLink[]" class="inputIG" placeholder="Instagram Username">
                    </div>
                </div>
